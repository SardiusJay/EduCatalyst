  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <p className="text-gray-600 mb-6">Kindly input new password</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full py-3 bg-purple-800 text-white font-medium rounded-lg hover:bg-purple-800 transition duration-200"
          >
            Proceed
          </button>
        </form>
